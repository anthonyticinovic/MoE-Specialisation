...
def format_comparison_table(stage2_metrics: Dict, stage3_metrics: Dict) -> str:
    ...
    lines.append(f"{'Mean Recall':<20} {s2_mean:>6.2f}%        {s3_mean:>6.2f}%        {delta_mean:+.2f}%")
    lines.append("="*80)
...
def main():
    ...
    stage2_metrics = {
        'image_to_text': i2t_stage2,
        'text_to_image': t2i_stage2
    }
    ...
    stage3_metrics = {
        'image_to_text': i2t_stage3,
        'text_to_image': t2i_stage3
    }
