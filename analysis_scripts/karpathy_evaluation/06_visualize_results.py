...
def plot_combined_comparison(
    ...
    plt.suptitle('Karpathy COCO Evaluation: Stage 2 vs Stage 3', fontsize=16, fontweight='bold', y=0.995)
...
def main():
    ...
    report = generate_text_report(
        retrieval_metrics,
        captioning_metrics,
        str(output_dir / 'evaluation_report.txt')
    )
