...
def main():
    ...
    for difficulty in difficulties:
        ...
        print(f"{'='*80}")
        print()
        print(f"{'Strategy':<20} {'Accuracy':<10} {'Yes%':<10} {'No%':<10} {'Unclear%':<10} {'F1':<10}")
        print("-"*80)
        ...
        for strategy in strategies:
            ...
            print(f"{strategy:<20} {m['accuracy']:>9.1f}% {m['yes_pct']:>9.1f}% {m['no_pct']:>9.1f}% {m['unclear_pct']:>9.1f}% {m['f1']:>9.1f}")
    ...
    for strategy in strategies:
        if strategy in avg_accuracies:
            print(f"{strategy:<20} {avg_accuracies[strategy]:>14.1f}% {avg_unclear[strategy]:>14.1f}% {avg_no_pct[strategy]:>9.1f}%")
