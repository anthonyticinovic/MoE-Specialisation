...
def extract_yes_no_answer(text: str, question: str = None) -> str:
    ...
    descriptive_starts = ['the image', 'there is', 'there are', 'this image', 'in the image', 
                          'the photo', 'this photo', 'a ', 'an ', 'it shows', 'it depicts']
...
def main():
    ...
    parser.add_argument('--priming', type=str, default='simple', 
