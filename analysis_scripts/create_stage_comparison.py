...
def create_comparison_plot(stage2_dir: str, stage3_dir: str, layer: int, output_dir: str, temperature: float = 0.01):
    ...
    if stage2_labels != stage3_labels:
        print(f"⚠️  Warning: Labels don't match between stages!")
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Directory with Stage 3 results"
    )
    parser.add_argument(
        "--layers",
        type=int,
    ...
    print(f"\n{'='*80}")
    print(f"✅ All comparison plots created!")
